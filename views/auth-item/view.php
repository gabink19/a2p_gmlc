...
<div class="auth-item-view">
    ...
    <?if ($remove_update===null) {?>
        ...
        <?= Html::a('Update', ['auth-item'."/".$update_action, 'id' => $model->name], ['class' => 'btn btn-primary']) ?>
    ...
    <?if ($remove_delete===null) {?>
        <?= Html::a('Delete', ['auth-item'."/".$delete_action, 'id' => $model->name], ['class' => 'btn btn-danger','data-method'=>'post']) ?>
