    ...
    if ($builder == 0) {
        ...
        if ($can_update == 1) {
            echo Html::button("<span class='glyphicon glyphicon-edit'></span>", [
                'value' => Url::to(['//report-generator-dashboard/get-data-report4', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name, 'builder' => 1]),
                'style' => 'background:none;border:none;padding:5px;color:black',
        ...
        echo Html::button("<span class='glyphicon glyphicon-list-alt'></span>", [
            'value' => Url::to(['//report-generator-dashboard/get-data-report4', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name, 'builder' => 0]),
            'style' => 'background:none;border:none;padding:5px;color:black',
            'class' => 'ReportGeneratormodalButton2 grid-action',
            'data-toggle' => 'tooltip',
            'data-placement' => 'bottom',
        ...
        echo Html::button("<span class='glyphicon glyphicon-th-list'></span>", [
            'value' => Url::to(['//report-generator-builder/change-page', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name,]),
            'style' => 'background:none;border:none;padding:5px;color:black',
        ...
        echo Html::button("<span class='glyphicon glyphicon-plus'></span>", [
            'value' => Url::to(['//report-generator-builder/add-page', 'folder' => $folder]),
            'style' => 'background:none;border:none;padding:5px;color:black',
            'class' => 'ReportGeneratormodalButton grid-action',
            'data-toggle' => 'tooltip',
            'data-placement' => 'bottom',
        ...
        echo Html::button("<span class='glyphicon glyphicon-remove'></span>", [
            'value' => Url::to(['//report-generator-builder/delete-page', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name,]),
        ...
        echo Html::button("<span class='glyphicon glyphicon-plus'></span>", [
            'value' => Url::to(['//report-generator-builder/add-report', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name,]),
            'style' => 'background:none;border:none;padding:5px;color:black',
            'class' => 'ReportGeneratormodalButton grid-action',
            'data-toggle' => 'tooltip',
            'data-placement' => 'bottom',
        ...
        if ($dashboard_name == "_dashboard_chart2a") {
            echo Html::button("<span class='glyphicon glyphicon-sort-by-attributes'></span>", [
                'value' => Url::to(['//report-generator-builder/sort-report', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name,]),
                'style' => 'background:none;border:none;padding:5px;color:black',
                'class' => 'ReportGeneratormodalButton grid-action',
                'data-toggle' => 'tooltip',
                'data-placement' => 'bottom',
        ...
        echo Html::button("<span class='glyphicon glyphicon-plus'></span>", [
            'value' => Url::to(['//report-generator-builder/add-filter', 'mode' => $mode, 'folder' => $folder, 'report_name' => $report_name,]),
            'style' => 'background:none;border:none;padding:5px;color:black',
            'class' => 'ReportGeneratormodalButton grid-action',
            'data-toggle' => 'tooltip',
            'data-placement' => 'bottom',
    ...
    <div id="demo" class="collapse">
        ...
        foreach ($column as $col) {
            ...
            if ($use_col != null && $use_col['filter_flag'] == 1) {
                ...
                echo $form->field($model, 'param' . $ke . '_3')->widget(
                ...
                if ($COLUMN_COMMENT != "") {
                    ...
                    if ($COLUMN_COMMENT_ARRAY[0] == 'ref') {
                        ...
                        echo $form->field($model, 'param' . $ke)->widget(
                            kartik\select2\Select2::classname(),
                            [
                                'hideSearch' => false,
            ...
            if ($data_type == 'date') {
                    ...
                    echo $form->field($model, 'param' . $ke . '_2')->widget(
                        kartik\widgets\DatePicker::classname(),
                        [
                            'value' => $model->param1,
        ...
        if ($ajax_mode == 0) {
            if ($filter_advance != "") {
                ...
                echo $form->field($model, 'param_adv_filter')->widget(
                    kartik\select2\Select2::classname(),
                    [
                        'hideSearch' => false,
