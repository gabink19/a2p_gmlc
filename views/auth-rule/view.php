...
<div class="auth-rule-view">
    ...
    <?if ($remove_update===null) {?>
        ...
        <?= Html::a('Update', ['auth-rule'."/".$update_action, 'id' => $model->name], ['class' => 'btn btn-primary']) ?>
    ...
    <?if ($remove_delete===null) {?>
        <?= Html::a('Delete', ['auth-rule'."/".$delete_action, 'id' => $model->name], ['class' => 'btn btn-danger','data-method'=>'post']) ?>
