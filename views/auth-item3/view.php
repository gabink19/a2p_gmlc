...
<div class="auth-item3-view">
    ...
    <?if ($remove_update===null) {?>
        ...
        <?= Html::a('Update', ['auth-item3'."/".$update_action, 'id' => $model->name], ['class' => 'btn btn-primary']) ?>
    ...
    <?if ($remove_delete===null) {?>
        <?= Html::a('Delete', ['auth-item3'."/".$delete_action, 'id' => $model->name], ['class' => 'btn btn-danger','data-method'=>'post']) ?>
