...
$attributes[]=['attribute' =>'tl_username','format' => 'raw','options' => []];
...
$attributes=[];
$attributes[]=['attribute' =>'tl_phone_number','format' => 'raw','options' => [],'labelColOptions'=>['style'=>'width:10%'],'valueColOptions'=>['style'=>'width:40%']];
$attributes[]=['attribute' =>'tl_email',
                                   ...
                                   'options' => [],
                                    ...
                                    ],'labelColOptions'=>['style'=>'width:10%'],'valueColOptions'=>['style'=>'width:40%']
                                   ];
$attributes2[]=['columns'=>$attributes];
$attributes=$attributes2;
$attributes[]=['attribute' =>'tl_address','format' => 'raw','options' => []];
// $attributes[]=['attribute' =>'tl_address2','format' => 'raw','options' => []];
$attributes2=$attributes;
$attributes=[];
$attributes[]=['attribute' =>'tl_city','format' => 'raw','options' => [],'labelColOptions'=>['style'=>'width:10%'],'valueColOptions'=>['style'=>'width:40%']];
$attributes[]=['attribute' =>'tl_country','format' => 'raw','options' => [],'labelColOptions'=>['style'=>'width:10%'],'valueColOptions'=>['style'=>'width:40%']];
$attributes2[]=['columns'=>$attributes];
$attributes=$attributes2;
...
$attributes[]=['attribute' =>'tl_change_password_duration',
                                   'type' => DetailView::INPUT_WIDGET,
                                    'options' => [],
                                    'widgetOptions' => [
                                        'class' => 'kartik\number\NumberControl',
...
$attributes2=$attributes;
$attributes=[];
$attributes[]=['attribute' =>'tl_retry_count','format' => 'raw','options' => [],'labelColOptions'=>['style'=>'width:10%'],'valueColOptions'=>['style'=>'width:40%']];
$attributes[]=['attribute' =>'tl_max_retry','format' => 'raw','options' => [],'labelColOptions'=>['style'=>'width:10%'],'valueColOptions'=>['style'=>'width:40%']];
$attributes2[]=['columns'=>$attributes];
$attributes=$attributes2;
?>
