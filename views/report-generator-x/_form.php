...
<div class="report-generator-x-form">
  ...
  <div style="overflow:auto;">
    <div style="float:right;">
      ...
      <?= Html::a(Yii::t('app', 'Cancel'), $redirect_url , ['class'=>'btn btn-primary']) ?>
    </div>
  </div>
...
<script>
  ...
  if (json != null) {
    ...
    function recurseLoad(node, parent) {
      var parent = parent
  ...
  function ajaxTree() {
    ...
    jQuery.ajax({
      type: "GET",
      url: 'index.php?r=report-generator-x%2Fget-data-report&table_name=' + table_name + '&table_alias=1',
      statusCode: {
        500: function() {
...
$redirect_url = Url::to(['report-generator-x/index']);
$js = <<<js
