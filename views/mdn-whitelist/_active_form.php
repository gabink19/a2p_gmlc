...
<?php     if ($view_form==null) $view_form='update2';
    ...
    'action' =>[$view_form,'id'=>$model->tmw_id,'app_mode'=>$app_mode],]
    ); ?>
    <?= $form->field($model,'tmw_aph_id')->textInput(['maxlength' => true,])?>

    <?= $form->field($model,'tmw_name')->textInput(['maxlength' => true,])?>

    <?= $form->field($model,'tmw_mdn')->textInput(['maxlength' => true,])?>
