 ...
 */
class XxAuthItem5Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
...
public function actionCreateAjax()   {
    ...
    /**
     * Displays a single AuthItem5 model.
     * @param string $id
     * @return mixed
...
public function actionCreate2()    
    ...
    /**
     * Updates an existing AuthItem5 model.
    ...
    /**
     * Deletes an existing AuthItem5 model.
    ...
    /**
     * Finds the AuthItem5 model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return AuthItem5 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AuthItem5::findOne($id)) !== null) {
            return $model;
        }
