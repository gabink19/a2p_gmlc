 ...
 */
class XxGHistoryLogController extends Controller
{
    /**
     * {@inheritdoc}
     */
...
public function actionIndex($app_mode=null)    {
        ...
        if (count($params) >0) {
            $Search_params = $params['GHistoryLogSearch'];
            if ($Search_params==null) {
                $Search_params=Yii::$app->session['GHistoryLogSearch'];
                if ($Search_params!=null){        
                    $params['GHistoryLogSearch']=$Search_params;
                }
            } else {
               Yii::$app->session['GHistoryLogSearch']=$Search_params;
               
            };
            
            $page_params = $params['page'];
            if ($page_params==null) {
                $page_params=Yii::$app->session['GHistoryLogSearch_page'];
                if ($page_params!=null){        
                    $_GET['page']=$page_params;
                }
                
            } else {
               Yii::$app->session['GHistoryLogSearch_page']=$page_params;
            ...
            if ($sort_params==null) {
                $sort_params=Yii::$app->session['GHistoryLogSearch_sort'];
                if ($sort_params!=null){
                    $_GET['sort']=$sort_params;
                }
                
            } else {
               Yii::$app->session['GHistoryLogSearch_sort']=$sort_params;
            }
        ...
        $searchModel = new GHistoryLogSearch();
...
public function actionCreateAjax($app_mode=null)   {
    ...
    /**
     * Displays a single GHistoryLog model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new GHistoryLog model.
...
public function actionCreate($app_mode=null)     
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            //return $this->redirect(['view', 'id' => $model->ghl_id]);
            if ($model->save()) {
...
public function actionCreate2($app_mode=null)    
    ...
    /**
     * Updates an existing GHistoryLog model.
    ...
    /**
     * Deletes an existing GHistoryLog model.
    ...
    /**
     * Finds the GHistoryLog model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return GHistoryLog the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = GHistoryLog::findOne($id)) !== null) {
            return $model;
        }
