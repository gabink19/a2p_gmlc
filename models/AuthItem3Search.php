...
/**
 * AuthItem3Search represents the model behind the search form of `app\models\AuthItem3`.
 */
class AuthItem3Search extends AuthItem3
{   
    ...
    {
        return [
            [['name', 'description', 'rule_name', 'data', 'menu1', 'menu2', 'menu3', 'menu_label', 'menu_url', 'first_user', 'first_ip', 'first_update', 'last_user', 'last_ip', 'last_update'], 'safe'],
            [['type'], 'integer'],
            [[], 'safe'],
    ...
    public function search($params,$master_id=null)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'menu3', $this->menu3])
